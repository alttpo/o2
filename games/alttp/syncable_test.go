...
func Test_syncableBitU8_GenerateUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:             true,
			wantAsm:          []byte{0xaf, 0x79, 0xf3, 0x7e, 0xc9, 0x0, 0xd0, 0x6, 0x9, 0x66, 0x8f, 0x79, 0xf3, 0x7e},
		...
		},
		{
			...
			want:             true,
			wantAsm:          []byte{0xaf, 0x79, 0xf3, 0x7e, 0xc9, 0x24, 0xd0, 0x6, 0x9, 0x42, 0x8f, 0x79, 0xf3, 0x7e},
		...
		},
		{
			...
			want:             true,
			wantAsm:          []byte{0xaf, 0x79, 0xf3, 0x7e, 0xc9, 0x42, 0xd0, 0x6, 0x9, 0x35, 0x8f, 0x79, 0xf3, 0x7e},
